...
- **Songs tab**: add your worship songs with their lyrics. You can optionally tag a song as "led by" a specific leader, and when that leader is rolled, their songs are preferred. Click **📜 View Lyrics** on the Worship Lead card (or **Lyrics** in the song list) to display the lyrics full-screen.
